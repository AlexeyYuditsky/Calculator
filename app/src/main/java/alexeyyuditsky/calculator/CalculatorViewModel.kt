...
class CalculatorViewModel(
    ...
    private var calculationState: CalculationState = DefiningLeftPart()
    ...
    override fun clickZero() = calculationState.handleZero(calculationParts, this)

    override fun clickOne() = calculationState.handleNumber("1", calculationParts, this)

    override fun clickTwo() = calculationState.handleNumber("2", calculationParts, this)

    override fun clickPlus() = calculationState.handlePlus(calculator, calculationParts, this)

    override fun clickMinus() = calculationState.handleMinus(calculator, calculationParts, this)

    override fun clickEquals() = calculationState.handleEquals(calculator, calculationParts, this)

    override fun clickClear() = calculationState.handleClear(calculationParts, this)
